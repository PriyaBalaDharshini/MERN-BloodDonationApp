    ...
    return (
        <div className="flex items-center justify-between h-[100px] px-[100px]">
            ...
            <div className="flex items-center justify-evenly cursor-pointer">
                <Link className="mr-4 text-[18px] font-medium" smooth={true} duration={1000} to="hero">Home</Link>
                <Link className="mr-4 text-[18px] font-medium" smooth={true} duration={1000} to="about"   >About Us</Link>
